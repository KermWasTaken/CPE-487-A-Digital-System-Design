...
HD_PWD='C:/Users/kermr/Numberle/Numberle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Numberle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Numberle.tcl
