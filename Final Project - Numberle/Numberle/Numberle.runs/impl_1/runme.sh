...
HD_PWD='C:/Users/kermr/Numberle/Numberle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Numberle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Numberle.tcl -notrace
